...
$sender = "Muhammad Puteela"; // ชื่อผู้ส่ง
$email_sender = "noreply@ibsone.com"; // เมล์ผู้ส่งเมลในนาม
$email_receiver = "----"; // เมล์ผู้รับ ***

$subject = "ลิงค์เชิญเข้าร่วมการสอบสัมภาษณ์ SCG"; // หัวข้อเมล์
		...
		<body>
			...
			<div style='padding:20px;'>
				...
				<div>				
					...
					<a href='https://www.facebook.com/MADputeela/' target='_blank'>
